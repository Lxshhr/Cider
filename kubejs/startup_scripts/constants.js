...
global.vanillaDisabled = [
    ...
    /minecraft:.*(?:andesite|cobblestone|granite|deepslate|blackstone|diorite|quartz|basalt|calcite|tuff|magma|debris|obsidian|soul|prismarine|sand|sandstone|mud|moss|chiseled|polished|infested|smooth|end_stone|purpur|nether|concrete).*/,
    ...
    'minecraft:bookshelf',
    'minecraft:lecturn',
    /minecraft:.*(?:tulip|bush|flower|daisy|lilac|vine|rose|plant|coral|dripleaf).*/,
    'minecraft:fern',
    ...
    'minecraft:apple',
    /minecraft:.*(?:skull|head|sculk|sponge|shulker)/,
    ...
    /minecraft:.*(?:podzol|mycelium|dirt|farmland|gravel|grass).*/,
    'minecraft:chain',
    'minecraft:spawner',
    'minecraft:observer',
    'minecraft:rail',
